...
namespace SPIDER {
  class Orders {
    ...
    public:
      ...
      // Installation
      static const byte REQ_MOVE_LEG         = 30;      // [order] [leg] [64 + dx] [64 + dy] [64 + dz]
      static const byte REQ_CALIBRATE        = 32;      // [order]

      // Blocking orders, range is 64 ~ 127

      // Installation
      static const byte REQ_INSTALL_STATE    = 64;      // [order]
      static const byte REQ_CALIBRATE_STATE  = 66;      // [order]
      static const byte REQ_BOOT_STATE       = 68;      // [order]
      static const byte REQ_CALIBRATE_VERIFY = 70;      // [order]
